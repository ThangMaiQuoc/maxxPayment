...
public enum ErrorEnum {
	...
	//
	TRANSACTION_NOT_FOUND("transaction","NotFound" ,"transaction is not found"),
	...
	ETHEREUM_NOT_FOUND("ethereum","notFound" , "ethereum not found"),
	...
	ADDRESS_NOT_FOUND("Address", "AddressNotFound", "The Address is not found"),

	CONFIG_NOT_FOUND("Config", "ConfigNotFound", "The Config is not found"),

	NOT_ENOUGH_MONEY("Wallet", "NotEnoughToAdd", "Wallet Not Enough Money to Add"),
